import { PARENTS as P } from '../content/site';
...
export default function Parents() {
  return (
    <main>
      ...
      <section className="section pt-0"><div className="wrap"><SectionHead chapter="La communication" title="Vous savez toujours où en est votre enfant." /><div className="mt-12"><CardGrid items={P.items} /></div></div></section>
